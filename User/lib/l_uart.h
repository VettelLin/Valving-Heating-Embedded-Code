...
#define print_endCharsOfLine(huart)		uart_write((UART_HandleTypeDef *)(huart), EndCharsOfLine, sizeof(EndCharsOfLine));

#define print_prompt(huart)		uart_transmit(huart, UartPrompt, sizeof(UartPrompt));
#define lnprint_prompt(huart)		uart_transmit(huart, EndCharsOfLine UartPrompt, sizeof(EndCharsOfLine UartPrompt))
#define println_prompt(huart)		uart_transmit(huart, UartPrompt EndCharsOfLine, sizeof(UartPrompt EndCharsOfLine))
